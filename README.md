...
- [ ] Научиться писать чистый Go
- [ ] Выложить 3 pet-проекта
- [ ] Сменить место работы на топовую компанию
...
|--------|------|----------|
| [cool-ai-bot](https://github.com/...) | Python, FastAPI | Бот, который генерирует арты с помощью DALL·E |
| [taskify](https://github.com/...) | Next.js, Tailwind | Простое ToDo с drag'n'drop |
| [cli-starter](https://github.com/...) | Go, Cobra | Базовый шаблон CLI-приложения |
...
<p align="center">
  ...
  <a href="https://spb.hh.ru/resume/9e76a511ff0d05e7a00039ed1f327142706761">HeadHunters</a>
</p>
